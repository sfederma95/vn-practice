...
const t1 = new Chat('hello world',c1.name,1000);
const t2 = new Chat('bye bye',c1.name,1000);
const t3 = new Chat('hello again again',c1.name,1000);
const d1 = new DialogueList([t1,t2,t3]);

const scene1 = {
    characters: [c1],
    setImg: c1.images['default'],
    dialogue: d1,
